...
class FormPanel extends JPanel implements ActionListener, ItemListener{
   ...
   public FormPanel(){   
      ...
      String[] courses={"[Select]", "KK14203 Object Oriented Programming"};
   ...
   public boolean printOutput(){
    ...
    public void writeInput(){
      ...
      //exception implementation
		try {
			// to append to file,FileWriter is initialized using below constructor
...
class MenuActionListener implements ActionListener {
   FormPanel fp;
   //receive FormPanel class in this constructor
